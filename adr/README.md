...
| [ADR-053](053-console-signing-modes-and-guided-operation.md) | Console signing modes and guided operation: a signing gateway and write view for the trust registry, gateway and browser-held-key modes named and shown in every governed-map console, guided lifecycle steps derived from the chain, and no sessions or passwords in any product |
