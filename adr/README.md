...
| [ADR-031.2](app-layer/031.2-guided-declarative-binding-editor.md) | Implemented (experimental, unreleased): catalog-driven binding authoring in Studio, safe YAML round trips, CLI-authoritative validation and rehearsal explanation; no runtime or deployment authority in the editor |
...
| [ADR-053](053-console-signing-modes-and-guided-operation.md) | Console signing modes and guided operation: a signing gateway and write view for the trust registry, gateway and browser-held-key modes in the trust registry console with the other consoles deferred, guided lifecycle steps derived from the chain, and no sessions or passwords in any product |
