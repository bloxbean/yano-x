...
import org.yanoproject.x.ipfs.internal.IpfsProviderException;
...
class IpfsEffectExecutorConformanceTest {
    ...
    private static final class ConformanceClient implements IpfsPinClient {
        ...
        @Override
        public PinState probe(org.yanoproject.x.integration.ipfs.CanonicalCid cid,
                              byte[] effectIdHash) {
            call(effectIdHash);
        ...
        @Override
        public void add(org.yanoproject.x.integration.ipfs.CanonicalCid cid,
                        boolean recursive,
                        byte[] effectIdHash) {
            call(effectIdHash);
