...
- [Yano core host boundary](../../docs/core-host.md)
...
```bash
./gradlew :connectors:effects-cardano:shadowJar
# connectors/effects-cardano/build/libs/
#   yano-x-effects-cardano-<version>-bundle.jar
```
...
descriptors. Yano X connector deployment is JVM-only.
...
```bash
./gradlew :connectors:effects-cardano:test
```
