...
`yano-x-objectstore-s3` is the first-party ADR-013 plugin bundle for the
...
- `yano-x-objectstore-s3-<version>.jar` is the thin compile-time artifact.
- `yano-x-objectstore-s3-<version>-bundle.jar` is the self-contained
