...
/** Shared HTTP plumbing of the portal and the operator gateway. */
final class HttpSupport {
    ...
    static void respondBytes(HttpExchange exchange, int status, byte[] bytes, String contentType)
            throws IOException {
    ...
    static ObjectNode receiptNode(DppClient.WriteResult result) {
