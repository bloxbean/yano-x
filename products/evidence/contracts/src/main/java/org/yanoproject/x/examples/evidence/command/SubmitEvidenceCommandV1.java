package org.yanoproject.x.examples.evidence.command;

import org.yanoproject.x.examples.evidence.internal.EvidenceValidation;
...
/** Canonical version-one evidence submission. */
public record SubmitEvidenceCommandV1(String evidenceId,
    ...
    /** Validates the domain fields and both nested frozen connector commands. */
    public SubmitEvidenceCommandV1 {
    ...
    public EvidenceCommandOperation operation() {
        return EvidenceCommandOperation.SUBMIT;
    }
    ...
    public boolean equals(Object other) {
        return this == other || other instanceof SubmitEvidenceCommandV1 command
