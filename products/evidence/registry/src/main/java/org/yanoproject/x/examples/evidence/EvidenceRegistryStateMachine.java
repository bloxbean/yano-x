...
import org.yanoproject.x.examples.evidence.command.EvidenceCommandCodec;
import org.yanoproject.x.examples.evidence.command.EvidenceCommandV1;
...
import org.yanoproject.x.examples.evidence.state.EvidenceEffectRef;
import org.yanoproject.x.examples.evidence.state.EvidenceHeadV1;
...
import org.yanoproject.x.examples.evidence.state.EvidenceScope;
import org.yanoproject.x.examples.evidence.state.EvidenceStatus;
import org.yanoproject.x.examples.evidence.state.EvidenceTerminalResultV1;
import org.yanoproject.x.examples.evidence.state.EvidenceTerminalOutcome;
import org.yanoproject.x.integration.ConnectorTypes;
import org.yanoproject.x.integration.ipfs.IpfsCidFingerprint;
import org.yanoproject.x.integration.ipfs.IpfsPinReceiptV1;
...
public final class EvidenceRegistryStateMachine implements AppStateMachine {
    ...
    private static void requireNotificationShape(EvidenceCommandV1 command) {
        ...
        var object = org.yanoproject.x.integration.objectstore
                .ObjectPutCommandV1.decode(objectCommand);
        var ipfs = org.yanoproject.x.integration.ipfs
