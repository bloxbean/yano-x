...
import org.yanoproject.x.roles.internal.ActorGovernanceProcessor;
...
public final class DomainActorRegistryComponent implements AppStateMachine {
    ...
    private DomainActorRegistryComponent(
        ...
        this.chainId = org.yanoproject.x.roles.contracts
    ...
    private static QueryRef queryRef(byte[] params) {
        try {
            ...
            org.yanoproject.x.roles.contracts.RoleWorkflowIdentifiers
