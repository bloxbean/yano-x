...
class AuthenticatedMapProofBundleTest {
    ...
    void verifiesDirectRoleBundleAndRejectsWrongGenesisAndStalePointer() throws Exception {
        ...
        var policy = new org.yanoproject.x.roles.contracts.DirectRolePolicyV1(
                "issuer-write", 1,
                org.yanoproject.x.roles.contracts.RecordStatus.ACTIVE,
                "issuer", 100);
        var actorKey = new org.yanoproject.x.roles.contracts.ActorKeyEpochV1(
                "issuer-a-k1", publicKey, 1, 0,
                org.yanoproject.x.roles.contracts.RecordStatus.ACTIVE);
        var actor = new org.yanoproject.x.roles.contracts.ActorRecordV1(
                "issuer-a", "acme", 1,
                org.yanoproject.x.roles.contracts.RecordStatus.ACTIVE,
                List.of("issuer"), List.of(actorKey), new byte[0]);
        var organization = new org.yanoproject.x.roles.contracts
        ...
        String approvals = org.yanoproject.x.roles.contracts
                .RoleWorkflowIdentifiers.ROLE_APPROVALS_COMPONENT_ID;
        String actors = org.yanoproject.x.roles.contracts
                .RoleWorkflowIdentifiers.DOMAIN_ACTORS_COMPONENT_ID;
        var keys = org.yanoproject.x.roles.contracts.RoleWorkflowKeys.class;
        ...
        byte[] policyKey = CompositeCommitmentV1.componentKey(approvals,
                org.yanoproject.x.roles.contracts.RoleWorkflowKeys
    ...
    void verifiesApprovalBundleAndRederivesClauseSatisfaction() throws Exception {
        ...
        var policy = new org.yanoproject.x.roles.contracts.ApprovalPolicyV1(
                "product-release", 1,
                org.yanoproject.x.roles.contracts.RecordStatus.ACTIVE,
                List.of("issuer"), List.of(
                new org.yanoproject.x.roles.contracts.ApprovalPolicyV1
                        .RequiredClause("independent-auditors", "auditor", 2,
                        org.yanoproject.x.roles.contracts.ApprovalPolicyV1
        ...
        var proposal = new org.yanoproject.x.roles.contracts
                ...
                20, org.yanoproject.x.roles.contracts.ApprovalProposalV1
        ...
        var underApproved = new org.yanoproject.x.roles.contracts
                .ApprovalProposalV1("release-1", "product-release", 1, policy.digest(),
                AuthenticatedMapAuthorizationContract.APPROVAL_PAYLOAD_DOMAIN, payloadHash,
                20, org.yanoproject.x.roles.contracts.ApprovalProposalV1
                .ProposalStatus.APPROVED, "issuer-a", "acme", 1, "issuer", 1,
    ...
    void verifiesAdministratorGovernanceBundleAndRederivesThreshold() {
        ...
        byte[] mutationHash = org.yanoproject.x.roles.contracts
        ...
        var organization = new org.yanoproject.x.roles.contracts
                ...
                org.yanoproject.x.roles.contracts.RecordStatus.ACTIVE,
                new byte[0]);
        var authority = new org.yanoproject.x.roles.contracts
                .AdministratorAuthorityV1("registry-admins", 1, List.of("admin-a"), 1, 1_000);
        var statement = new org.yanoproject.x.roles.contracts
                .AdministratorStatementV1(
                org.yanoproject.x.roles.contracts.AdministratorStatementV1
                        .Decision.PROPOSE,
                CHAIN, Hex.decode(GENESIS), "registry-admins", 1, "mutation-1",
                mutationHash, 1, 30, "admin-a", 1, "admin-a-k1", publicKey, 1, 20,
                org.yanoproject.x.roles.contracts.AdministratorStatementV1
                        .ED25519);
        var vote = new org.yanoproject.x.roles.contracts
                .AcceptedAdministratorVoteV1(
                org.yanoproject.x.roles.contracts
                        .SignedAdministratorStatementV1.sign(statement, adminSeed),
                "acme", 1, 1);
        var mutation = new org.yanoproject.x.roles.contracts
                ...
                org.yanoproject.x.roles.contracts.GovernedMutationRecordV1
                        .Status.ACTIVATED, 1);
        var result = new org.yanoproject.x.roles.contracts
                .RoleCommandResultV1(
                org.yanoproject.x.roles.contracts.RoleCommandResultV1
                        .KIND_REGISTRY_GOVERNANCE,
                "mutation-1",
                org.yanoproject.x.roles.contracts.RoleWorkflowResultCode
        ...
        var widerAuthority = new org.yanoproject.x.roles.contracts
                .AdministratorAuthorityV1("registry-admins", 1,
                List.of("admin-a", "admin-b"), 2, 1_000);
        var underThreshold = new org.yanoproject.x.roles.contracts
                .GovernedMutationRecordV1("mutation-1", mutationBytes, mutationHash,
    ...
    private static AssembledBundle governanceBundle(
            org.yanoproject.x.roles.contracts.RoleCommandResultV1 result,
            org.yanoproject.x.roles.contracts.GovernedMutationRecordV1
                    mutation,
            org.yanoproject.x.roles.contracts.AdministratorAuthorityV1
                    authority,
            org.yanoproject.x.roles.contracts.ActorRecordV1 actor,
            org.yanoproject.x.roles.contracts.OrganizationRecordV1
                    organization,
            byte[] messageId
    ) {
        String actors = org.yanoproject.x.roles.contracts
    ...
    private static AssembledBundle approvalBundle(
            org.yanoproject.x.roles.contracts.ApprovalProposalV1 proposal,
            AuthenticatedMapAuthorizationContract.ApprovalConsumptionV1 consumption,
            org.yanoproject.x.roles.contracts.ApprovalPolicyV1 policy,
        ...
        for (Map.Entry<String, byte[]> identity : seeds.entrySet()) {
            ...
            var actorKey = new org.yanoproject.x.roles.contracts
    ...
    private static org.yanoproject.x.roles.contracts.ApprovalProposalV1
            .AcceptedDecisionV1 decision(
            String actorId, String organizationId, byte[] seed, byte[] payloadHash) {
        var statement = new org.yanoproject.x.roles.contracts
                .ActorStatementV1(
                org.yanoproject.x.roles.contracts.ActorStatementV1
                        .Action.APPROVE,
                CHAIN, "release-1", "product-release", 1,
                AuthenticatedMapAuthorizationContract.APPROVAL_PAYLOAD_DOMAIN, payloadHash,
                20, actorId, 1, actorId + "-k1", "independent-auditors");
        byte[] signature = org.yanoproject.x.roles.contracts
                .SignedActorCommandV1.sign(statement, seed).signature();
        return new org.yanoproject.x.roles.contracts.ApprovalProposalV1
                .AcceptedDecisionV1(
                org.yanoproject.x.roles.contracts.ActorStatementV1
                        .Action.APPROVE,
