...
class BatchSettlementTransactionBuilderTest {
    ...
    void shardContinuationEmitsTheThreadTokenOutputWithThePostInsertDatum()
        ...
        org.yanoproject.x.eutxo.contracts.EutxoShardDatum datum =
                new org.yanoproject.x.eutxo.contracts
                        .EutxoShardDatum(1, "payments", 7, shard, nextRoot);
        org.yanoproject.x.eutxo.contracts.EutxoShardContinuation
                continuation = new org.yanoproject.x.eutxo
        ...
        assertThat(org.yanoproject.x.eutxo.contracts
        ...
        org.yanoproject.x.eutxo.contracts.EutxoShardContinuation
                wrongShard = new org.yanoproject.x.eutxo
                .contracts.EutxoShardContinuation(
