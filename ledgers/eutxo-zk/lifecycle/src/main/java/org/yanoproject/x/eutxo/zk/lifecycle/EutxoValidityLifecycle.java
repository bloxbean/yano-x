package org.yanoproject.x.eutxo.zk.lifecycle;
...
import org.yanoproject.x.eutxo.zk.contracts.EutxoZkBatchVerificationKey;
    ...
    private Map<String, Object> contractPlan(
        ...
        plan.put("validators", List.of(
                validator("deposit-staging",
                        "org.yanoproject.x.eutxo.bridge.onchain.DepositStagingValidator"),
                validator("accepted-funds-vault",
                        "deployment-pinned-native-or-reviewed-custody-script"),
                validator("validity-root",
                        "org.yanoproject.x.eutxo.zk.onchain.EutxoValidityRootValidator"),
                validator("batch-data",
                        "org.yanoproject.x.eutxo.zk.onchain.EutxoValidityRootValidator#data-availability"),
                validator("proof-withdrawal-vault",
                        "org.yanoproject.x.eutxo.zk.onchain.EutxoProofWithdrawalVaultValidator")));
