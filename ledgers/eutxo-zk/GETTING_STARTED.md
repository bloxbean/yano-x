...
```bash
./gradlew \
  :ledgers:eutxo-zk:contracts:test \
  :ledgers:eutxo-zk:zeroj:test \
  :ledgers:eutxo-zk:prover:test \
  :ledgers:eutxo-zk:client:test \
  :ledgers:eutxo-zk:onchain:test \
  :ledgers:eutxo-zk:testkit:test \
  :ledgers:eutxo-zk:lifecycle:test \
  :ledgers:eutxo-zk:runtime:check
```
