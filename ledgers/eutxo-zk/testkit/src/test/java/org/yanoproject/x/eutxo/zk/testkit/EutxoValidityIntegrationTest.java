package org.yanoproject.x.eutxo.zk.testkit;
...
import org.yanoproject.x.eutxo.contracts.EutxoStateKeys;
...
import org.yanoproject.x.eutxo.zk.contracts.EutxoValidityWitness;
...
class EutxoValidityIntegrationTest {
    ...
    void selectedOptionalProviderMaintainsAtomicSecondRoot() {
        ...
        var authorizationProfile =
                org.yanoproject.x.eutxo.zk.contracts
                        .EutxoZkAuthorizationProfile.JUBJUB_DEVELOPMENT_V1;
        EutxoL2Domain domain = new EutxoL2Domain(
                "eutxo-zk-test",
                "devnet",
