---
title: "Bring external evidence into your application"
description: "Generic observations let an application use external information through a shared verification policy. For example, a workflow can wait for a signed…"
editUrl: "https://github.com/bloxbean/yano-x/edit/main/docs/site/observations.md"
---
...
The [shipment reference](https://github.com/bloxbean/yano-x/blob/main/docs/appchain/shipment-observation-reference.md) shows a
...
The [ADA/USD reference](https://github.com/bloxbean/yano-x/blob/main/docs/appchain/ada-usd-observation-reference.md) demonstrates
