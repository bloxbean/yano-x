...
Use the [App-Chain Studio](../../../tooling/studio/src/main/web/index.html) to
...
L1 anchoring. Follow [the proof guide](../PROOF_LAB.md) to retrieve and verify the
...
Continue with [adding a chain](add-chain.md) or [remote operations](operators.md).
