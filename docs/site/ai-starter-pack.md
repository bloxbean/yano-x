...
| Need | Source |
|---|---|
| Live recipes, capabilities, modules, config properties | [`/ai/catalog.json`](/ai/catalog.json) |
| Everything on this site as one file | [`/llms-full.txt`](/llms-full.txt) |
